...
export default function Footer({
  ...
  return (
    <footer
      className="mt-24 border-t border-white/10 glass-overlay"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 ">
          ...
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.legal.map(({ page, href }) => (
                    <li key={page}>
                      <Link
                        to={href}
                        className="text-base text-white/60 hover:text-white transition-colors"
          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="glass-input appearance-none min-w-0 w-full rounded-md py-2 px-4 text-base placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/30"
                placeholder={t('footer.emailPlaceholder')}
              />
              <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button
                  type="submit"
                  className="glass-button w-full rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/30"
                >
                  {t('footer.subscribe')}
                </button>
              </div>
        ...
        <div className="mt-8 border-t pt-8">
          <a
            className="flex items-center space-x-4 font-medium text-white/60 hover:text-white transition-colors"
