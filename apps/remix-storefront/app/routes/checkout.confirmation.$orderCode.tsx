...
import { trackPurchase, trackPageView } from '~/utils/monitoring';
...
export default function CheckoutConfirmation() {
  ...
  // Track purchase and page view
  useEffect(() => {
    if (order && !order.active) {
      // Order is complete, track purchase
      const total = order.totalWithTax;
      trackPurchase(order.code, total, order.currencyCode);
    }
